...
//       delete dbUsers.branStark.password;
//         console.log(dbUsers.branStark.email);
//         const id = (await User.findOne({email: dbUsers.branStark.email}))._id;
//
//       return request(src)
//         .patch(`/v1/users/${id}`)
...
//           expect(res.body).to.be.an(dbUsers.branStark);
//         });
//     });
//
//     it('should report error "User does not exist" when user does not exists', () => {
...
//       User.findAndGenerateToken(dbUsers.branStark)).accessToken;
//
...
//   });
//
//   describe.only('PATCH /password/:userId', () => {
//     /* it('should update user password', async () => {
//            const id = (await User.findOne({email: dbUsers.jonSnow.email}))._id;
//            console.log(id);
//            const passwordData = {oldPassword: dbUsers.jonSnow.password, newPasswprd: 'newpass'};
//            return request(src)
...
//
//
//     /* it('old password not correct', async () => {
//             const id = (await User.findOne({email: dbUsers.jonSnow.email}))._id;
//             const passwordData = {oldPassword: 'wrongpassword', newPasswprd: 'newpass'};
//             return request(src)
//                 .post(`/v1/users/password/${id}`)
//                 .send(passwordData)
//                 .set('Authorization', `Bearer ${userAccessToken}`)
//                 .expect(httpStatus.UNAUTHORIZED)
//                 .then((res) => {
