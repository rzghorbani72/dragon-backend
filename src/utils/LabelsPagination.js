 ...
 * @returns {Promise}
 */
function EventAggregatePaginate(countResult, options, callback) {
  options = options || {};
  ...
  const labelPrevPage = options.customLabels.prevPage
    ...
    : "prevPage";
  const labelHasNextPage = options.customLabels.hasNextPage
    ? options.customLabels.hasNextPage
    : "hasNextPage";
  const labelHasPrevPage = options.customLabels.hasPrevPage
    ? options.customLabels.hasPrevPage
    : "hasPrevPage";
...
export default EventAggregatePaginate;
